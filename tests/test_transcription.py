...
async def test_openai_provider_send_audio():
    ...
    on_final = MagicMock()
    provider = OpenAIProvider(api_key="test_key", on_partial=on_partial, on_final=on_final)
...
async def test_assemblyai_provider_send_audio():
    on_partial = MagicMock()
    on_final = MagicMock()
    provider = AssemblyAIProvider(api_key="test_key", on_partial=on_partial, on_final=on_final)
