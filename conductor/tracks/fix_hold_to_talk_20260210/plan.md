...
- [ ] Task: Manual Acceptance Test.
    - [ ] Run the app with `hold_to_talk = true`.
    - [ ] Verify that typing while holding the hotkey does not stop the transcription.
- [ ] Task: Conductor - User Manual Verification 'Phase 2: Final Validation' (Protocol in workflow.md)
