...
## Phase 2: OpenAI Provider Enhancement [checkpoint: 97b886c]

Update the OpenAI provider to consume the new granular settings.



- [x] Task: Refactor `OpenAIProvider` connection logic [97b886c]
...
- [x] Task: Write tests for OpenAI provider updates [97b886c]
...
- [x] Task: Conductor - User Manual Verification 'Phase 2: OpenAI Provider Enhancement' (Protocol in workflow.md) [97b886c]



## Phase 3: AssemblyAI V3 Migration [checkpoint: 97b886c]

Migrate the AssemblyAI provider to the Streaming V3 API and support new parameters.



- [x] Task: Refactor `AssemblyAIProvider` for V3 [97b886c]
...
- [x] Task: Write tests for AssemblyAI V3 migration [97b886c]
...
- [x] Task: Conductor - User Manual Verification 'Phase 3: AssemblyAI V3 Migration' (Protocol in workflow.md) [97b886c]



## Phase 4: Audio Integration & Documentation [checkpoint: 97b886c]

Connect the global audio settings and finalize the project artifacts.



- [x] Task: Update `AppCoordinator` and `AudioStreamer` integration [97b886c]

    - [x] Ensure `AudioStreamer` uses `capture_sample_rate` from config.

    - [x] Pass `chunk_ms` or calculated chunk size to the streamer/pipe.

- [x] Task: Finalize documentation and examples [97b886c]
...
- [x] Task: Perform final smoke tests [97b886c]

    - [x] Verify both providers connect successfully in Test Mode with the new config.

- [x] Task: Conductor - User Manual Verification 'Phase 4: Audio Integration & Documentation' (Protocol in workflow.md) [97b886c]
