...
## Phase 3: Quality Assurance & "Done" Gate [checkpoint: 2ca5a8f]
- [x] Task: Run project-wide linting and formatting
    - [x] `uv run ruff check --fix .`
    - [x] `uv run ruff format .`
- [x] Task: Run type checking
    - [x] `uv run mypy .`
- [x] Task: Final test execution
    - [x] `uv run pytest -q`
