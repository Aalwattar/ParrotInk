...
- [x] Task: Create `tests/test_audio_device_selection.py` to verify device binding.
- [x] Task: Perform manual verification with hardware switching (if possible) or mock device listing.
- [x] Task: Run the 'Definition of Done Gate' (`ruff`, `mypy`, `pytest`).
