...
def test_log_pii_redaction():
    ...
    formatted1 = formatter.format(logging.LogRecord("test", logging.DEBUG, "path", 1, msg1, None, None))
    ...
    formatted2 = formatter.format(logging.LogRecord("test", logging.DEBUG, "path", 1, msg2, None, None))
